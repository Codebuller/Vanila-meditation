...
const app = () =>{
  const song: HTMLAudioElement|null = document.querySelector('.song');
const play: HTMLImageElement|null = document.querySelector('.play');
const outline: SVGCircleElement|null = document.querySelector('.moving-outline circle');
const video: HTMLVideoElement|null = document.querySelector('.vid-container video');
